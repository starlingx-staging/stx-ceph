...
%endif
URL:		http://ceph.com/
Source0:	%{?_remote_tarball_prefix}ceph-13.2.0.tar.gz
%if 0%{?suse_version}
...
#cp wrs/wrs_git_version %{_builddir}/%{name}-%{version}/src/.git_version
#
#echo "....................................... sdh ......................................."
#echo $PWD
#
#cp -rf /localdisk/designer/dehao/starlingx/cgcs-root/stx/git/ceph/src/zstd %{_builddir}/%{name}-%{version}/src/.
#echo "copy zstd....done........sdh "
#
#cp -rf /localdisk/designer/dehao/starlingx/cgcs-root/stx/git/ceph/src/spdk %{_builddir}/%{name}-%{version}/src/.
#echo "copy spdk"
#
